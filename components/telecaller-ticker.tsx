...
export function TelecallerTicker() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const achieved = leads?.reduce((sum: number, lead: any) => sum + (lead.disbursed_amount || lead.loan_amount || 0), 0) || 0
      ...
      if (pending <= 0) {
        ...
        setMessage(`Hey ${name}! 🎯 ${formattedPending} more to go to hit your target. Keep the momentum going—you can do it! 💥`)
      }
    }
