    ...
    useEffect(() => {
        const fetchFunnel = async () => {
            ...
            const counts = {
                ...
                'Contacted': data.filter((d: any) => ['Contacted', 'Follow Up', 'Interested', 'Login Done', 'Disbursed'].includes(d.status)).length,
                'Interested': data.filter((d: any) => ['Interested', 'Documents_Sent', 'Login Done', 'Disbursed'].includes(d.status)).length,
                'Login Done': data.filter((d: any) => ['Login Done', 'Transferred to KYC', 'Disbursed'].includes(d.status)).length,
                'Disbursed': data.filter((d: any) => d.status === 'Disbursed').length,
            };
