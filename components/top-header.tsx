                  ...
                  <BreadcrumbItem>
                    {item.isLast ? (
                      ...
                      <BreadcrumbLink asChild>
                        <Link href={item.href} className="text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 transition-colors">
                          {item.label}
                        </Link>
                      </BreadcrumbLink>
                    )}
        ...
        {loading ? (
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="rounded-full h-9 w-9 border border-slate-200 dark:border-slate-800 hover:shadow-md transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 flex items-center justify-center bg-white dark:bg-slate-950 cursor-pointer">
